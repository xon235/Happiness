...
class FamilyListAdapter()
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FamilyListAdapter.FamilyViewHolder {
        return FamilyViewHolder(NavActionLayoutBinding.inflate(
            LayoutInflater.from(parent.context), parent, false))
    }

    override fun onBindViewHolder(holder: FamilyListAdapter.FamilyViewHolder, position: Int) {
